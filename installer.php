...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211205_ccddb7ee963b7d0d4069_20211205172412_archive.zip';
	const ARCHIVE_SIZE		 = '210766225';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ccddb7e-05172412';
    const SECONDARY_PACKAGE_HASH = '5f80a8c-05172412';
	const VERSION			 = '1.4.3';
